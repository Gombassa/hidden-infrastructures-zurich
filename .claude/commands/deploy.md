...
6. Confirm the push succeeded and remind the user that Cloud Run will pick up the change automatically at https://hidden-infrastructures-zurich-50944718104.europe-west2.run.app/
