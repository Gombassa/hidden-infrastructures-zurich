...
|---|---|---|---|
| `lk-sewage.geojson` | 12,726 | pipe: 12,726 | 5.57 MB (5,572,005 B) |
| `lk-electricity.geojson` | 25,295 | cable: 18,108, node: 7,187 | 10.96 MB (10,963,113 B) |
| `lk-water.geojson` | 18,208 | pipe: 12,715, fitting: 5,493 | 7.10 MB (7,095,036 B) |
| `lk-tram-lk.geojson` | 12,526 | trasse: 8,002, node: 2,494, area: 2,030 | 6.17 MB (6,165,208 B) |
| `lk-telecom.geojson` | 29,664 | cable: 22,797, node: 4,560, area: 2,307 | 14.05 MB (14,049,398 B) |
| `lk-fernwaerme.geojson` | 568 | pipe: 568 | 293.2 KB (293,173 B) |

**110 GeoShop orders processed** (55297–56970) · **98,987 total features** across 6 files · **44.14 MB (44,137,933 B)** served.
