...
|---|---|---|---|
| `lk-sewage.geojson` | 12,585 | pipe: 12,585 | 5.51 MB (5,513,822 B) |
| `lk-electricity.geojson` | 24,999 | cable: 17,887, node: 7,112 | 10.84 MB (10,836,207 B) |
| `lk-water.geojson` | 17,912 | pipe: 12,512, fitting: 5,400 | 6.98 MB (6,981,217 B) |
| `lk-tram-lk.geojson` | 12,432 | trasse: 7,952, node: 2,467, area: 2,013 | 6.12 MB (6,115,981 B) |
| `lk-telecom.geojson` | 29,102 | cable: 22,367, node: 4,463, area: 2,272 | 13.77 MB (13,765,200 B) |
| `lk-fernwaerme.geojson` | 568 | pipe: 568 | 293.2 KB (293,173 B) |

**109 GeoShop orders processed** (55297–56969) · **97,598 total features** across 6 files · **43.51 MB (43,505,600 B)** served.
