...
|---|---|---|---|
| `lk-sewage.geojson` | 14,471 | pipe: 14,471 | 6.28 MB (6,277,252 B) |
| `lk-electricity.geojson` | 28,749 | cable: 20,635, node: 8,114 | 12.44 MB (12,438,153 B) |
| `lk-water.geojson` | 21,066 | pipe: 14,750, fitting: 6,316 | 8.23 MB (8,225,216 B) |
| `lk-tram-lk.geojson` | 13,164 | trasse: 8,389, node: 2,712, area: 2,063 | 6.40 MB (6,401,971 B) |
| `lk-telecom.geojson` | 34,555 | cable: 26,601, node: 5,332, area: 2,622 | 16.26 MB (16,257,688 B) |
| `lk-fernwaerme.geojson` | 593 | pipe: 593 | 306.7 KB (306,684 B) |

**115 GeoShop orders processed** (55297–57145) · **112,598 total features** across 6 files · **49.91 MB (49,906,964 B)** served.
