...
|---|---|---|---|
| `lk-sewage.geojson` | 13,532 | pipe: 13,532 | 5.90 MB (5,898,011 B) |
| `lk-electricity.geojson` | 26,902 | cable: 19,270, node: 7,632 | 11.64 MB (11,644,637 B) |
| `lk-water.geojson` | 19,545 | pipe: 13,679, fitting: 5,866 | 7.62 MB (7,622,361 B) |
| `lk-tram-lk.geojson` | 12,814 | trasse: 8,165, node: 2,599, area: 2,050 | 6.28 MB (6,275,745 B) |
| `lk-telecom.geojson` | 32,080 | cable: 24,655, node: 4,976, area: 2,449 | 15.14 MB (15,144,755 B) |
| `lk-fernwaerme.geojson` | 568 | pipe: 568 | 293.2 KB (293,173 B) |

**112 GeoShop orders processed** (55297–57049) · **105,441 total features** across 6 files · **46.88 MB (46,878,682 B)** served.
